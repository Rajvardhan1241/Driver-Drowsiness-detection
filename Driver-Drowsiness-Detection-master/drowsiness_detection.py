...
mixer.init()
sound = mixer.Sound(r'C:\Users\rajva\OneDrive\Desktop\mega-pro\Drowsiness detection oldd\alarm.wav')

cap = cv2.VideoCapture(0)

detector = dlib.get_frontal_face_detector()
predictor = dlib.shape_predictor(r"C:\Users\rajva\OneDrive\Desktop\mega-pro\Drowsiness detection oldd\Driver-Drowsiness-Detection-master\shape_predictor_68_face_landmarks.dat")
